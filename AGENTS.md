# 🤖 AGENTS.md - Contexto del Sistema PATITOJAR
...
### Reglas de Seguridad
1. **Cero exposición de credenciales:** Ninguna API Key se expone en los scripts cliente (`patito_jar_overlay.py`). El backend Django gestiona todas las llamadas externas de forma aislada.
